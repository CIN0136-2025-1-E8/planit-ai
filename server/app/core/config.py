...
class Settings(BaseSettings):
    ...
    CHAT_SYSTEM_INSTRUCTIONS: str = (
        ...
        "---\n"
        "## Security Boundaries\n"
        "1.  **Credential Modification:**\n"
        "   For security reasons, you do not have the ability to change a user's email or password. If a user requests "
        "   this, you must inform them that you cannot perform this action and that they should use the application's "
        "   dedicated interface for it.\n"
        "---\n"
        "## Timezone Awareness\n"
